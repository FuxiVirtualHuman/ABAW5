...
class Pipeline_Incep(nn.Module):
    def __init__(self,dropout_prob=0.6):
        ...
        self.type = type
        self.student = InceptionResnetV1(pretrained="vggface2", dropout_prob=dropout_prob)
        self.linear1 = nn.Linear(512, 16, bias=False)
        print("===============load pretrained parameters===============")
        state_dict = torch.load("/data/Workspace/ABAW/code_ABAW5/checkpoints/minus_pipeline_student_InceptionResnet_0.861.pth")
